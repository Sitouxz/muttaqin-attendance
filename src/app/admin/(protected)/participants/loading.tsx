export default function ParticipantsLoading() {
  return (
    <div className="p-8 animate-pulse">
      ...
      <div className="h-11 w-72 bg-[#173d35]/8 rounded-lg mb-4" />
      <div className="bg-white rounded-[1.5rem] shadow-ambient overflow-hidden">
        {[...Array(10)].map((_, i) => (
          <div key={i} className="flex items-center gap-4 px-4 py-2.5 border-b border-[#f0f4f3]">
            ...
            <div className="h-4 w-44 bg-[#173d35]/8 rounded" />
            <div className="h-4 w-24 bg-[#173d35]/6 rounded" />
            <div className="h-4 w-10 bg-[#173d35]/6 rounded" />
            <div className="h-5 w-14 bg-[#173d35]/10 rounded-full ml-auto" />
          </div>
        ))}
      </div>
    </div>
